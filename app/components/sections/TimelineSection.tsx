    ...
    <section id="programme" className="relative py-60 paper-bg-kaki text-mariage-white overflow-hidden">            
      <div className="relative z-10 px-8 max-w-[430px] mx-auto">
        ...
        {[
          ...
          { time: "16:00", event: "Instant photo & Vin d'honneur", loc: "Salle des fêtes Bouranton, 14 rue de l’école 10270", detail: "Photo et dégustation" },
          { time: "18:00", event: "Salle des fêtes & Début de soirée", loc: "Salle des fêtes Bouranton, 14 rue de l’école 10270", detail: "Célébration jusqu'à 1h30 du matin" },
        ].map((item, idx) => (
