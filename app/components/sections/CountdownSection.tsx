...
export default function CountdownSection() {
  ...
  useEffect(() => {
    setIsMounted(true); // Évite les erreurs de rendu (Hydration) avec Next.js
    const target = new Date("2026-09-26T14:30:00").getTime();
    ...
    if (distance > 0) {
      setTimeLeft({
        ...
        clearInterval(timer); // Arrête le compteur le jour J
      }
    }, 1000);
